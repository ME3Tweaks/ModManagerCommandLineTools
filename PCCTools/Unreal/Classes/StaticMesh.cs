...
namespace PCCTools.Unreal.Classes
{
    public class StaticMesh
    {
        ...
        public void DeserializeDump(byte[] raw)
        {
            ...
            {
                Console.WriteLine("StaticMesh Error: " + e.Message);
            }
        }
        ...
        public void Render(Device device, Matrix m)
        {
            ...
            try
            {
                for (int i = 0; i < Mesh.Mat.Lods[0].SectionCount; i++)
                {
                    ...
                    if (sec.RawTriangles == null)
                    {
                        ...
                        {
                            Console.WriteLine("Static Mesh error on reading dx mesh: " + e.Message);
            ...
            {
                Console.WriteLine("Static Mesh ERROR: " + e.Message);
            }
        }
        ...
        public void Export3DS(Lib3dsFile f, Matrix m)
        {
            ...
            {
                Console.WriteLine("Export to 3ds ERROR: in\"" + MyName + "\" " + e.Message);
            }
        }
